    ...
    public OAuthControllerWithGoogle(UserRepository userRepository) {
	  ...
	  @GetMapping("/google-login")
	    public String googleLogin(
	            ...
	            HttpSession session,
	            Model model) {
		  System.out.println("Calling the google Login Methods Okay :=");

		  if (oauthUser == null) {
	        	System.out.println("The User is null Checking here Okay:=");
...
//	            String email = oauthUser.getAttribute("email");
	 ...
	 */	        	// Google attributes
	            String googleId = oauthUser.getAttribute("sub");   // UNIQUE
	            String email    = oauthUser.getAttribute("email");
	            String name     = oauthUser.getAttribute("name");
